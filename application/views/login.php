            ...
            <div class="form-group">
                ...
                <div class="agrupador">
                    <div class="input-group">
                        ...
                        <input type="password" class="form-control" placeholder="Contrase&ntilde;a" id="contrasena" maxlength="40" onkeyup="Login.index.validarNumeroCaracteres(this,8); Login.index.mensajeUsuarioContrasenaIncorrecto(false)">
                    </div>
                    ...
                    <div class="has-error mensaje">
                        <label class="control-label oculto" for="contrasena" id="usuario_contrasena_incorrecta">&iexcl;Usuario o contrase&ntilde;a incorrecta!</label>
                    </div>
                </div>
            </div>
        </div>
