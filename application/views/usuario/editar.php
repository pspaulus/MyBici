                        ...
                        <div class="agrupador">
                            <div class="form-group">
                                ...
                                <div class="mensaje">
                                    ...
                                    <div class="col-xs-9 col-xs-offset-3 vacio oculto text-left">
                                        <label class="control-label" for="nombre_editar"
                                               id="nombre_editar_vacio">&iexcl;Ingrese usuario!</label>
                                    </div>
                                    <div class="col-xs-11 col-xs-offset-1 error oculto">
                                        <label class="control-label" for="nombre_editar"
                        ...
                        <div class="agrupador">
                            <div class="form-group">
                                ...
                                <div class="mensaje">
                                    ...
                                    <div class="col-xs-10 col-xs-offset-2 error oculto">
                                    <label class="control-label" for="contrasena_editar"
                        ...
                        <div class="agrupador">
                            <div class="form-group">
                                ...
                                <div class="mensaje">
                                    ...
                                    <div class="col-xs-7 col-xs-offset-2 has-error">
