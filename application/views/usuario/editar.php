                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-6 mensaje">
                                    <input class="form-control" id="nombre_editar<?= $obj_usuario->id ?>" type="text"
                                           maxlength="40" placeholder="Ingrese un nombre"
                                           value="<?= $obj_usuario->nombre ?>"
                                           onkeyup="Usuario.acciones.validarNumeroCaracteresUsuario(this,4)">
                                    <label class="control-label vacio oculto" for="nombre_editar"
                                           id="nombre_editar_vacio">&iexcl;Ingrese usuario!</label>
                                    <label class="control-label error oculto" for="nombre_editar"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-6 mensaje">
                                    <input class="form-control" id="contrasena_editar<?= $obj_usuario->id ?>"
                                           type="password" maxlength="40" placeholder="Ingrese una contrase&ntilde;a"
                                           value="<?= $obj_usuario->contrasena ?>"
                                           onkeyup="Usuario.acciones.validarNumeroCaracteresUsuario(this,8)">
                                    <label class="control-label vacio oculto" for="contrasena_editar"
                                           id="contrasena_editar_vacio">&iexcl;Ingrese contrase&ntilde;a!</label>
                                    <label class="control-label error oculto" for="contrasena_editar"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-6 mensaje">
                                    <input class="form-control" id="confirmar_contrasena_editar<?= $obj_usuario->id ?>"
                                           type="password" maxlength="40" placeholder="repita la contrase&ntilde;a"
                                           value="<?= $obj_usuario->contrasena ?>"
                                           onkeyup="Usuario.acciones.validarNumeroCaracteresUsuario(this,8)">
                                    <label class="control-label vacio oculto" for="confirmar_contrasena_editar"
                                           id="confirmar_contrasena_vacio">&iexcl;Ingrese confirmaci&oacute;n de
                                        contrase&ntilde;a!</label>
                                    <label class="control-label error oculto" for="confirmar_contrasena_editar"
